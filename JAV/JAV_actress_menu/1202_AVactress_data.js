...
window.actressData = {
  ...
  "cup": "G",
  "description": "等到誰呢？等到這位いちか先生(一香老師)，有在註意片商Faleno官方Twitter的朋友應該都注意到了，除了這兩個月的大型見面會活動外，這家片商主推的就是這位いちか先生(一香老師)，不斷地提醒大家她即將上課了～為什麼、為什麼這位超級約德爾人、只有143公分高的いちか先生(一香老師)得到了巨人般的待遇呢？答案很簡單，她和S1的うんぱい(Unpai)一樣是做流量的網紅，也一樣是用TikTok吸睛—但當然是うんぱい(Unpai)比較厲害，她的粉絲數可是比三上還多，至於いちか先生(一香老師)呢，她則是擁有17萬的追踪⋯雖然うんぱい(Unpai)到目前為止的表現沒想像中強，不過看到17萬的追踪數Faleno還是情不自禁地愛上了いちか先生(一香老師)：因為她不只是個網紅，與うんぱい(Unpai)她也是個粉紅色的頭髮以及喜歡Cosplay成動漫角色的習慣讓這位業界的新人怎麼看都會迷死暗黑界的動漫粉，所以Faleno不但簽下去了還比其他新人更快啟動宣傳：只看看到うんぱい(Unpai)的狀況，我實在很怕いちか先生(一香先生)手上旳17萬大軍不夠用啊⋯看了試看也大概知道為什麼Faleno會這麼早就讓いちか先生(一香先生)和大家見面：就算你不認識什麼動漫角色，但這位新人粉紅色的頭髮、各式各樣的瞳孔放大片以及可愛的小虎牙當做個辣妹也很不錯；再加上雜誌寫真的助攻，照理來說いちか先生(一香老師)應該是挺值得期待的，就看看Faleno怎麼經營了：作者：丿小鹤丶 https://www.bilibili.com/read/cv17011047 出处：bilibili",
  "features": [
    "美人",
    "美乳",
    "大乳房",
  ...
  "detail_url": "https://www.javrate.com/Actor/Detail/75c0346c-5ae8-49b5-9808-49b28e4e3a97.html",
  "aliases": [
    "Sensei Ichika"
  ],
  "gallery": [
