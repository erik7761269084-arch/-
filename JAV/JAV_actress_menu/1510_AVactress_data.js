...
window.actressData = {
  ...
  "cup": "C",
  "description": "有村千佳是日本知名AV女优。由2010年发行第一部单体作品。\n\n家里养了两只吉娃娃こうた（康太）和のん（小希），并非常宠爱他们。\n\n身材姣好，涉及范围也较为混杂，也曾与各个大社团有过合作\n\n偶尔会自拍cosplay并发到博客上。也有几部COSPLAY作品。COS质量均为中上乘。被誉为日本「COSPLAY女优四天王」之一。\n\n其作品也均以撸点高而著称。\n\n由于身体不适等原因，有村千佳于2015年5月2日隐退[1]。5月2日参加的ちかっぽトークライブVol.2为有村千佳隐退前参加的最后一次活动。\n\n官方博客在5月3日最后一次更新后也停止更新。巧合的是，5月3日最后更新正好是博客第1001条。",
  "features": [
    "美少女",
    "長相可愛",
    "長相甜美"
  ],
  "detail_url": "https://www.javrate.com/Actor/Detail/da1b1474-c0f9-40e8-98b9-e5a8c2483c7e.html",
  "aliases": [
    "Chika Arimura",
    "Erika Kimura",
    "MIKU",
