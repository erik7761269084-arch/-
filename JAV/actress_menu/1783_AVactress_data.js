...
window.actressData = {
  ...
  "measurements_display": "93G/59/90",
  "cup": "G",
  "description": "水樹璃子（日語：水樹璃子，1998年9月20日—），日本的AV女優，山梨縣出身[1]。所屬於「Mine'S」事務所[2][3]。興趣是運動、料理跟寫東西（有硬筆書法資格）[1]。1歲到6歲時學過游泳，中學時期是陸上部短跑運動員，高中時期也參加陸上部[4]。出道前是美容専門學校二年級的學生，且已經在山梨縣當地的美容院找到工作[5]。初體驗是跟高中二年級第一次見面的男朋友同學，在出道之前只與對方有過性經驗[4]。2018年9月，成為日本AV片商「SOD Create」旗下品牌「キミホレ」的專屬女優AV出道[6][7][8]。2019年離開SOD，目前以企劃單體女優身分活動。",
  "features": [
    "美人",
    "美乳",
    "大乳房",
  ...
  "detail_url": "https://www.javrate.com/Actor/Detail/7fdafc13-1473-4cb9-9749-3b7b1aa01cd6.html",
  "aliases": [
    "Mirei Kuraki",
    "Reo Tsubaki",
    "Riko Mizuki",
