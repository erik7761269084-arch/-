// 487_AVactress_data.js
window.actressData = {
  "id": 487,
  "name": "雛乃ゆな",
  "age": 22,
  "birthday_date": "2003-09-12",
  ...
  "cup": "F",
  "description": "真相大白了！有在追女優社群的朋友，一定注意到市場上有幾個以不露臉的方式提前啟動宣傳的女優，隸屬於事務所LINX的「雛乃ゆな(雛乃由奈，https://twitter.com/yuna_hinano)」就是其中之一：她說了，自己會在愚人節的4月1日情報解禁，所以ー所以除非是記錯了，那她就不會是片商Moodyz那一掛的(因為4月1日星期一，那些片商是昨天(星期二)發表工作清單)！然後她就現身了，是Faleno Star的人〜大家覺得如何？我的想法是現在的新人真厲害，不是奶特別大就是腰超級細，而雛乃ゆな(雛乃由奈)是兩者兼具：作品的標題寫得很清楚了，她是「Z世代最強クビレBODYチアリーダー」（Z世代最強䐯身的啦啦隊員)，所以可以想見的是她會用那極不科學的水蛇腰穿上啦啦隊制服跳炸裂，但Faleno Star沒告訴我們的是她還有F罩杯的上圍以及8頭身的比例然後還一碰就濕超敏感，這⋯這當然要幹死她啊，還用說嗎？其實看了文案和劇照就大概知道雛乃ゆな(雛乃由奈)的狀況，她身材無敵、比例高挑、在床上很容易引發男人的慾望，如果要雞蛋裡挑骨頭的話大概就是臉蛋沒那麼優秀；而看了影片就更清楚了，雛乃ゆな(雛乃由奈)的身材和伊藤舞雪一樣是走超細腰配爆乳路線的，然後她不只敏感更是抖M所以男優在前戲以及本番的時候動不動就是打屁股然後用各種道具搞她，如果一根雞雞不夠那就再塞一根給她玩3P，就是要讓咱們這些AVer像是晚上看到月亮的孫悟空一樣變成狂暴的大腥腥：所以問題就是她的臉你OK嗎？給過嗎？",
  "features": [
    "美人",
    "美乳",
    "美腳",
  ...
  "detail_url": "https://www.javrate.com/Actor/Detail/4e68e620-293b-4c74-b32d-c19880dd0c7f.html",
  "aliases": [
    "Yuna Hinano",
    "雏乃由奈",
    "雛乃由奈"
  ...
  "gallery": [
    "https://picture.yoshiclub.xyz/20240408/c0c89a11-b5a5-44aa-9356-ed0054f2067e.jpg",
    "https://picture.yoshiclub.xyz/20240408/0d892398-f2b3-4cb4-bcf3-0c0bacc35395.jpg",
