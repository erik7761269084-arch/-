// 1366_AVactress_data.js
window.actressData = {
  "id": 1366,
  "name": "桃井杏南",
  "age": 37,
  "birthday_date": "1988-03-31",
  ...
  "measurements_display": "88F/60/94",
  "cup": "F",
  "description": "這是6月7日發片檔最大的謎團！那就是由片商Madonna發行的作品「名もなき素人妻、中出しライダー01。 高速騎乗位で膣内射精を求める専業主婦 Aさん 32歳」：標題說的很清楚了，演出的這位家庭主婦Aさん是個「中出騎士」，看到硬幫幫的棒子她就要坐上去、用她自傲的騎乘位擠出水來…又是中出騎士又是高速的騎乘位，再加上文案一開始就說這位Aさん擁有「美白神尻×美乳Fカップ(美白神尻＋美乳F罩杯)」的好條件，怎麼樣？你是不是想知道這位Aさん的真實身分？結果不看還好，一看才知道這傢伙不單純啊…有多不單純呢？首先，這位Aさん的藝名多得嚇人，在大家都喜歡參考的網站「素人系総合wiki」她就有超過10個不同的藝名；再來，這位號稱是專業主婦的Aさん不只在AV界的履歷表非常精采而且是個憎恨馬賽克的女人，讓人印象最深的應該就是她模仿立花美涼前進東京很熱(Tokyo-Hot)集中營出操的演出：那時候的她叫做七草アンナ(七草安娜)，你可能也看過她用田中志乃、茉莉もも(茉莉桃)、七草まつり(七草茉莉)，松田茜等名字演出的無碼片。別因為拍了很多無碼片就覺得這位女優條件差，相反地，就因為她身材不錯又有著一張娃娃臉才有那麼多無碼片商想和她合作。只是一路從2007年鼠牛虎兔龍蛇馬羊猴雞狗豬看了12年下來，每次要寫她的時候我就想問：「妳現在貴姓大名？」答案是「桃井杏南」，在twitter上的名稱可以知道她又回來這一行了：雖然在這一行闖蕩多年，早已經是輕熟女的年紀了，但那張娃娃臉還是可以讓她穿著學生服在這一行橫著走。你還記得她嗎？不記得也沒關係，在現在的事務所她應該不會片子發得那麼亂了，所以就請記住桃井杏南這名字，然後有空去找她之前在東熱的演出就行了～",
  "features": [
    "美人",
    "美乳",
    "美腳",
  ...
  "detail_url": "https://www.javrate.com/Actor/Detail/403b5d3f-ac15-464d-a4c0-654b3836fda5.html",
  "aliases": [
    "Anna Momoi",
    "Aya Fujino",
    "Fuuka Mizuno",
