// 654_AVactress_data.js
window.actressData = {
  "id": 654,
  "name": "夏目未來",
  "age": 24,
  "birthday_date": "2001-08-08",
  ...
  "cup": "E",
  "description": "最近一波引退潮有沒有嚇到你？唉，正所謂舊的不去新的不來，AV界也是這樣的，新的一直來於是舊的一直去，新人一個一個冒出頭讓老將發現時不我予，只好看破紅塵、下台一鞠躬〜但AV界有趣的是有些女優的下台是為下一次走上舞台做準備，請各位看看「夏目みらい(夏目未來)」，有沒有認出她是誰？答案是超M的「武田エレナ(武田繪玲奈)」，她移籍更換事務所後也變了藝名，了解經紀公司關係的人就知道她這個跳槽代表的意義，原本的經紀公司可能會不太高興⋯但我真正想講的是她，うさみ鈴(宇佐美鈴)。她是誰呢？她就是「赤瀬尚子」，還記得之前筆者曾經報導她在twitter上宣布引退，結果因為她把發文刪掉了所以我只好把文章設為隱藏，想知道她接下來要怎麼做：結果後來她還是把twitter帳號刪掉了退出事務所ー為什麼要先發文宣布引退再刪文然後又炸掉帳號這麼麻煩？很簡單，因為赤瀬尚子沒有照規矩來，她宣布引退前完全沒有和事務所報告，所以事務所請她先刪文然後雙方再好好談了一談⋯但赤瀬尚子辭意甚堅，事務所也不再挽留，於是她就刪帳號離開了ー只是這個離開指的是離開經紀公司而不是AV界，所以在找到新東家後她換個名字又出來了〜這就是文章一開始說的，女優引退有些是不想幹了，有些則是發現時不我予只好離開舞台不要惹人嫌；很明顯地，赤瀬尚子之前或許曾經不想幹，但她其實不想走其實還想留，所以換了間經紀公司、有了新的藝名後她又回來啦：以經紀公司的能力，我認為換了藝名的赤瀬尚子想要找回過去發片的盛況恐怕沒那麼容易，不過之前既然承諾會把事情做完所以這篇收尾的文章還是有其必要，喜歡她的朋友就請注意うさみ鈴(宇佐美鈴)的發片訊息吧。",
  "features": [],
  "detail_url": "https://www.javrate.com/Actor/Detail/fa0d8a12-8ce3-4e5c-87c6-a1e57867b6da.html",
  "aliases": [
    "Erena Takeda",
    "Mirai Natsume",
    "Sakamoto Rio",
  ...
  "gallery": [
    "https://picture.yoshiclub.xyz/20231126/ff2def96-3bcb-4536-ae3c-7abf8587feb3.jpg",
